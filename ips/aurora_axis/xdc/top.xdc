...
# These set of constraints should ideally be included in the 
# parent project's constraint file. Uncomment when using as 
# a standalone project, instead as an IP.
#
