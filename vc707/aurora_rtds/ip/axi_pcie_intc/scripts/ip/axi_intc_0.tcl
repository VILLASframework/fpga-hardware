...
# Create IP
create_ip -vendor xilinx.com -library ip -name axi_intc -module_name axi_intc_0 -dir $ipDir
...
generate_target all [get_files axi_intc_0.xci]
...
create_ip_run [get_files -of_objects [get_fileset sources_1] [get_files */axi_intc_0.xci]]

launch_runs -jobs 16 axi_intc_0_synth_1
wait_on_run axi_intc_0_synth_1
