//----------------------------------------------------------------------------//
//  File: axi_pcie_v2_7_1_axi_enhanced_rx.v                         //
//                                                                            //
//  Description:                                                              //
...
module axi_pcie_v2_7_1_axi_enhanced_rx #(
  ...
  axi_pcie_v2_7_1_axi_enhanced_rx_pipeline #(
  ...
  axi_pcie_v2_7_1_axi_enhanced_rx_destraddler #(
    .C_DATA_WIDTH( C_DATA_WIDTH ),
    .C_FAMILY( C_FAMILY ),
    .TCQ( TCQ )
  ...
  //---------------------------------------------------------------------------
   ...
   axi_pcie_v2_7_1_axi_enhanced_rx_null_gen #(
    .C_DATA_WIDTH( C_DATA_WIDTH ),
    .TCQ( TCQ )
  ...
  //---------------------------------------------//
   ...
   axi_pcie_v2_7_1_axi_enhanced_rx_demux #(
    .C_DATA_WIDTH( C_DATA_WIDTH ),
    .C_FAMILY( C_FAMILY ),
