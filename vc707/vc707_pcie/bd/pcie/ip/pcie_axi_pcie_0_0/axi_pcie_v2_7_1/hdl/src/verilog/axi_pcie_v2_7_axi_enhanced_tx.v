//----------------------------------------------------------------------------//
//  File: axi_pcie_v2_7_1_axi_enhanced_tx.v                         //
//                                                                            //
//  Description:                                                              //
...
module axi_pcie_v2_7_1_axi_enhanced_tx #(
...
axi_pcie_v2_7_1_axi_enhanced_tx_port_mux #(
  ...
  axi_pcie_v2_7_1_axi_enhanced_tx_pipeline #(
    .C_DATA_WIDTH( C_DATA_WIDTH ),
    .TCQ( TCQ ),
  ...
  // TX Arbiter                                  //
  //---------------------------------------------//
  axi_pcie_v2_7_1_axi_enhanced_tx_arbiter #(
