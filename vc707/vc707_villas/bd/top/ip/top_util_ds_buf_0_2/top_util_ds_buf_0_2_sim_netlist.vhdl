...
-- Date        : Thu Apr 16 18:23:49 2020
-- Host        : ubuntu-svg-xilinx.acs-lab.eonerc.rwth-aachen.de running 64-bit Ubuntu 16.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/svg-hka/VILLASfpga-hardware/vc707/vc707_villas/bd/top/ip/top_util_ds_buf_0_2/top_util_ds_buf_0_2_sim_netlist.vhdl
-- Design      : top_util_ds_buf_0_2
...
entity top_util_ds_buf_0_2_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of top_util_ds_buf_0_2_util_ds_buf : entity is "ibufdsgte2";
  attribute C_SIZE : integer;
  attribute C_SIZE of top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_util_ds_buf_0_2_util_ds_buf : entity is "util_ds_buf";
end top_util_ds_buf_0_2_util_ds_buf;

architecture STRUCTURE of top_util_ds_buf_0_2_util_ds_buf is
...
entity top_util_ds_buf_0_2 is
  ...
  attribute NotValidForBitStream of top_util_ds_buf_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_util_ds_buf_0_2 : entity is "top_util_ds_buf_0_2,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of top_util_ds_buf_0_2 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of top_util_ds_buf_0_2 : entity is "util_ds_buf,Vivado 2018.3";
end top_util_ds_buf_0_2;

architecture STRUCTURE of top_util_ds_buf_0_2 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 125000000, CLK_DOMAIN top_util_ds_buf_0_2_IBUF_DS_ODIV2, INSERT_VIP 0";
  attribute x_interface_info of IBUF_DS_P : signal is "xilinx.com:interface:diff_clock:1.0 CLK_IN_D CLK_P";
  attribute x_interface_parameter of IBUF_DS_P : signal is "XIL_INTERFACENAME CLK_IN_D, BOARD.ASSOCIATED_PARAM DIFF_CLK_IN_BOARD_INTERFACE, CAN_DEBUG false, FREQ_HZ 125000000";
  attribute x_interface_info of IBUF_OUT : signal is "xilinx.com:signal:clock:1.0 IBUF_OUT CLK";
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 125000000, CLK_DOMAIN top_util_ds_buf_0_2_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.top_util_ds_buf_0_2_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
