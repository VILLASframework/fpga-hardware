...
entity hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
    generic(
             dwidth     : integer := 100; 
             awidth     : integer := 4; 
             mem_size    : integer := 13
...
architecture rtl of hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is 
...
entity hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    generic (
...
architecture arch of hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V is
    component hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom_U :  component hls_dft_sinf_or_cosf_hls_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
